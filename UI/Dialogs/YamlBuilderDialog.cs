...
public sealed class YamlBuilderDialog : Window
{
    ...
    private YamlBuilderDialog(Window? owner, string displayName, string apWorldName)
    {
        ...
        if (_template == null)
        {
            list.Children.Add(NoTemplateNote(displayName, engine));
        }
        else
        {
    ...
    {
        // Two different missing things, two different fixes -- saying "no
        // template" would leave the player guessing which.
