...
// bridge actually works end-to-end (BizHawk — proven with Pokémon Emerald).
...
// (per-emulator capability table §2, build-order §6.2).
...
public sealed record EmulatorBackend
{
    ...
    // the tag the win-x64 asset hangs off (e.g.
