...
public sealed class HintEntry
{
    ...
    // True once the hinted location check is completed.
    ...
    // so entries parsed from them leave these at 0.
    ...
    // Slot that RECEIVES the hinted item (0 = unknown).
    // cross-game name resolution: the item id lives in this slot's game.
    public int    ReceiverSlot { get; set; }

    // AP item ID in the receiver's game namespace (0 = unknown).
