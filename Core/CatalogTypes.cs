...
{
    // All files are downloaded from GitHub/CDN.
    DirectDownload,
...
// summary of InstallStrategy.
// cards, the detail page badge, and the "Available" filter ("available" =
// the launcher itself can get you playing, i.e.
...
{
    // Short role label shown in bold.
...
public sealed record GameLinks
{
    ...
    // ROM / base game purchase link (e.g.
