...
namespace LauncherV2.Plugins.MetroCUBEvania;

// ═══════════════════════════════════════════════════════════════════════════════
// MetroCUBEvaniaPlugin — launch integration for "MetroCUBEvania", a PICO-8
// Metroidvania with Archipelago integration.
//
// ── FACTS ─────────────────────────────────────────────────────────────────────
//   * PICO-8 game. Releases at: https://github.com/ap-metrocubevania/ap-metrocubevania
...
//       1. metrocubevania.html  — open in default browser
//       2. *.html (any HTML file in GameDirectory) — open first one found
//       3. *.p8 (any cart in GameDirectory)
//       4. Fallback: open GitHub releases page in browser
//
...
public sealed class MetroCUBEvaniaPlugin : IGamePlugin
{
    // ── Constants ────────────────────────────────────────────────────────────

    private const string GH_OWNER    = "ap-metrocubevania";
    private const string GH_REPO     = "ap-metrocubevania";
    private const string GH_RELEASES = "https://api.github.com/repos/ap-metrocubevania/ap-metrocubevania/releases";
    private const string REPO_URL    = "https://github.com/ap-metrocubevania/ap-metrocubevania";
    private const string RELEASES_URL = "https://github.com/ap-metrocubevania/ap-metrocubevania/releases";
    ...
    public string GameId      => "metrocubevania";
    public string DisplayName => "MetroCUBEvania";
    public string Subtitle    => "PICO-8 · AP client required";
    public string ApWorldName => "MetroCUBEvania";

    public string IconPath
        => Path.Combine(AppContext.BaseDirectory, "Assets", "metrocubevania.png");

    public string ThemeAccentColor => "#8040FF";   // purple

    public string[] GameBadges => new[] { "PICO-8", "Free Download" };

    public string Description =>
        "MetroCUBEvania is a Metroidvania-style PICO-8 game with Archipelago integration.";
    ...
    // ── AP bridge events ──────────────────────────────────────────────────────
    // MetroCUBEvania does not connect to the AP server itself — the player
...
#pragma warning restore CS0067
    ...
    {
        progress.Report((50, "Opening MetroCUBEvania releases page..."));
        try
        {
        ...
        progress.Report((100,
            "Download MetroCUBEvania from the GitHub releases page. You can play " +
    ...
    public System.Windows.UIElement? CreateSettingsPanel()
    {
        ...
        browseBtn.Click += (_, _) =>
        {
            ...
            {
                Title = "Select MetroCUBEvania folder",
        ...
        panel.Children.Add(new System.Windows.Controls.TextBlock
        {
            Text = "MetroCUBEvania does not have a built-in AP client. Use the " +
        ...
        {
            ("MetroCUBEvania on GitHub ↗",   REPO_URL),
    ...
    ///   Priority 1: metrocubevania.html
    ///   Priority 2: any *.html in the directory
    ///   Priority 3: any *.p8 in the directory
    ...
    private string? ResolveGameFile()
    {
        ...
        string preferred = Path.Combine(dir, "metrocubevania.html");
